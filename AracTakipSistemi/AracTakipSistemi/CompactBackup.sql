-- AracTakipSistemi Küçük Boyutlu Backup Scripti
-- Bu script sadece veri yapısını ve temel verileri içerir

USE AracTakip;
GO

-- Sadece tablo yapılarını oluştur (veri olmadan)
...
PRINT 'Küçük boyutlu backup tamamlandı!'; 